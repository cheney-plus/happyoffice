...
export const tMain = createI18n({
  zh: {
    ...
    errNoModel: '未配置模型名称',
    errGskCli: 'gsk 未登录:请先运行 Friday 登录 Friday 账号',
    errNoDeckAppend:
  ...
  en: {
    ...
    errGskCli: 'gsk not signed in: run Friday to sign in to your Friday account first',
    errNoDeckAppend:
  ...
  ja: {
    ...
    errGskCli:
      'gsk が未サインインです。先に Friday を実行して Friday アカウントにサインインしてください',
    errNoDeckAppend:
  ...
  ko: {
    ...
    errGskCli:
      'gsk가 로그인되어 있지 않습니다. 먼저 Friday을 실행해 Friday 계정에 로그인하세요',
    errNoDeckAppend:
  ...
  fr: {
    ...
    errGskCli:
      "gsk non connecté : exécutez d'abord Friday pour vous connecter à votre compte Friday",
    errNoDeckAppend:
  ...
  de: {
    ...
    errGskCli:
      'gsk nicht angemeldet: Führen Sie zuerst Friday aus, um sich bei Ihrem Friday-Konto anzumelden',
    errNoDeckAppend:
  ...
  es: {
    ...
    errGskCli:
      'gsk sin sesión iniciada: ejecuta primero Friday para iniciar sesión en tu cuenta de Friday',
    errNoDeckAppend:
  ...
  th: {
    ...
    errGskCli: 'gsk ยังไม่ได้เข้าสู่ระบบ: โปรดรัน Friday เพื่อเข้าสู่ระบบบัญชี Friday ก่อน',
    errNoDeckAppend:
  ...
  id: {
    ...
    errGskCli: 'gsk belum masuk: jalankan Friday dulu untuk masuk ke akun Friday',
    errNoDeckAppend:
  ...
  ru: {
    ...
    errGskCli:
      'gsk не авторизован: сначала выполните Friday, чтобы войти в учётную запись Friday',
    errNoDeckAppend:
  ...
  ar: {
    ...
    errGskCli: 'gsk غير مسجَّل الدخول: شغّل Friday أولًا لتسجيل الدخول إلى حساب Friday',
    errNoDeckAppend:
  ...
  pt: {
    ...
    errGskCli: 'gsk não conectado: execute Friday primeiro para entrar na sua conta Friday',
    errNoDeckAppend:
  ...
  it: {
    ...
    errGskCli:
      "gsk non ha effettuato l'accesso: esegui prima Friday per accedere al tuo account Friday",
    errNoDeckAppend:
  ...
  pl: {
    ...
    errGskCli:
      'gsk nie jest zalogowany: najpierw uruchom Friday, aby zalogować się na konto Friday',
    errNoDeckAppend:
  ...
  cs: {
    ...
    errGskCli: 'gsk není přihlášen: nejprve spusťte Friday a přihlaste se k účtu Friday',
    errNoDeckAppend:
  ...
  nl: {
    ...
    errGskCli:
      'gsk is niet aangemeld: voer eerst Friday uit om u aan te melden bij uw Friday-account',
    errNoDeckAppend:
  ...
  ms: {
    ...
    errGskCli:
      'gsk belum log masuk: jalankan Friday dahulu untuk log masuk ke akaun Friday anda',
    errNoDeckAppend:
  ...
  he: {
    ...
    errGskCli: 'gsk אינו מחובר: הרץ תחילה Friday כדי להיכנס לחשבון Friday שלך',
    errNoDeckAppend:
  ...
  hi: {
    ...
    errGskCli: 'gsk साइन इन नहीं है: पहले Friday चलाकर अपने Friday खाते में साइन इन करें',
    errNoDeckAppend:
  ...
  'zh-TW': {
    ...
    errNoModel: '未設定模型名稱',
    errGskCli: 'gsk 未登入:請先執行 Friday 登入 Friday 帳號',
    errNoDeckAppend:
