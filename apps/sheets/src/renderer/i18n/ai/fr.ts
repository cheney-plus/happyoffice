...
export const fr = {
  ...
  aiGskLoginBtn: 'Se connecter à Friday',
  ...
  aiFridayAccount: 'Compte Friday',
  aiAccountChecking: 'Vérification…',
  aiLoggedIn: 'Connecté',
  aiLoggedInAs: 'Connecté : {email}',
  aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Friday)',
  aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
  aiLoginFriday: 'Se connecter à Friday',
  aiModel: 'Modèle',
  aiCancel: 'Annuler',
  aiSave: 'Enregistrer',
