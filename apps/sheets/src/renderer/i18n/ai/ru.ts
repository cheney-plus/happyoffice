...
export const ru = {
  ...
  aiFridayAccount: 'Учётная запись Friday',
  aiAccountChecking: 'Проверка…',
  aiLoggedIn: 'Вход выполнен',
  aiLoggedInAs: 'Вход выполнен: {email}',
  aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Friday)',
  aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
  aiLoginFriday: 'Войти в Friday',
  aiModel: 'Модель',
  aiCancel: 'Отмена',
  aiSave: 'Сохранить',
