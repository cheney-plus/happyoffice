...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 Friday:请点击下方「登录 Friday」完成登录后重试',
  ...
  en: {
    ...
    errGskNotLoggedIn:
      'Not signed in to Friday: click “Sign in to Friday” below, sign in, then retry',
  ...
  ja: {
    ...
    errGskNotLoggedIn:
      'Friday にサインインしていません。下の「Friday にサインイン」からサインインして再試行してください',
  ...
  ko: {
    ...
    errGskNotLoggedIn:
      'Friday에 로그인되어 있지 않습니다. 아래 "Friday 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
  ...
  fr: {
    ...
    errGskNotLoggedIn:
      'Non connecté à Friday : cliquez sur « Se connecter à Friday » ci-dessous, connectez-vous puis réessayez',
  ...
  de: {
    ...
    errGskNotLoggedIn:
      'Nicht bei Friday angemeldet: Klicken Sie unten auf „Bei Friday anmelden“, melden Sie sich an und versuchen Sie es erneut',
  ...
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en Friday: pulsa «Iniciar sesión en Friday» abajo, inicia sesión y vuelve a intentarlo',
  ...
  th: {
    ...
    errGskNotLoggedIn:
      'ยังไม่ได้ลงชื่อเข้าใช้ Friday: แตะ “ลงชื่อเข้าใช้ Friday” ด้านล่าง แล้วลองอีกครั้ง',
  ...
  id: {
    ...
    errGskNotLoggedIn: 'Belum masuk ke Friday: klik “Masuk ke Friday” di bawah, lalu coba lagi',
  ...
  ru: {
    ...
    errGskNotLoggedIn:
      'Вы не вошли в Friday: нажмите «Войти в Friday» ниже, войдите и повторите попытку',
  ...
  ar: {
    ...
    errGskNotLoggedIn:
      'لم تسجّل الدخول إلى Friday: انقر على «تسجيل الدخول إلى Friday» أدناه ثم أعد المحاولة',
  ...
  pt: {
    ...
    errGskNotLoggedIn:
      'Não conectado ao Friday: clique em “Entrar no Friday” abaixo, entre e tente novamente',
  ...
  it: {
    ...
    errGskNotLoggedIn:
      'Accesso a Friday non effettuato: fai clic su “Accedi a Friday” qui sotto, accedi e riprova',
  ...
  pl: {
    ...
    errGskNotLoggedIn:
      'Nie zalogowano do Friday: kliknij „Zaloguj się do Friday” poniżej, zaloguj się i spróbuj ponownie',
  ...
  cs: {
    ...
    errGskNotLoggedIn:
      'Nejste přihlášeni do Friday: klikněte níže na „Přihlásit se do Friday“, přihlaste se a zkuste to znovu',
  ...
  nl: {
    ...
    errGskNotLoggedIn:
      'Niet aangemeld bij Friday: klik hieronder op “Aanmelden bij Friday”, meld u aan en probeer het opnieuw',
  ...
  ms: {
    ...
    errGskNotLoggedIn:
      'Belum log masuk ke Friday: klik “Log masuk ke Friday” di bawah, kemudian cuba lagi',
  ...
  he: {
    ...
    errGskNotLoggedIn: 'לא מחובר ל-Friday: לחץ על "התחבר ל-Friday" למטה, התחבר ונסה שוב',
  ...
  hi: {
    ...
    errGskNotLoggedIn:
      'Friday में साइन इन नहीं है: नीचे “Friday में साइन इन करें” पर क्लिक करें, साइन इन करें और फिर से कोशिश करें',
  ...
  'zh-TW': {
    ...
    errGskNotLoggedIn: '未登入 Friday:請點擊下方「登入 Friday」完成登入後重試',
...
export function registerAiIpc(): void {
  ...
  // Friday account (Friday state): auth source for AI features; the frontend uses it to prompt login when logged out
  ipcMain.handle(
    'ai:gsk-status',
  ...
  ipcMain.handle('ai:stream', async (event, request: AiStreamRequest) => {
    ...
    // the genspark key never enters the settings file; requests take it from the Friday state
  ...
  // settings-UI connection test for the media provider (genspark = the Friday state)
